    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Flight = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Hotel = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CarRental = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JoinEntities", x => x.DestinationTripId);
                    table.ForeignKey(
                        name: "FK_JoinEntities_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "DestinationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JoinEntities_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinEntities_DestinationId",
                table: "JoinEntities",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_JoinEntities_TripId",
                table: "JoinEntities",
                column: "TripId");
